...
// -SebaSphere's Dev Notes: We aren't the first people to "borrow" this class LMAO. Found a plugin and a mod that used this class.
// May look into optimizations if game lags but **probably** fine
